                                    ...
                                    <div class="widget-stats-large-info-container">
                                        ...
                                        <div class="card-body account">
                                            <ul class="list-group account list-group-flush">
                                                ...
                                                <li class="list-group-item number">Number : {{$number->body}}</li>
                                                <li class="list-group-item device">Device : </li>
                                            </ul>
                                            <div class="text-center mt-4">
                                                <a href="{{ route('settings') }}" class="btn btn-primary mb-1"><i class="material-icons">code</i>Settings</a>
                                                <button class="btn btn-danger btn-xs delete" data-slug="{{ $number->id }}" data-del-url="{{ route('device.destroy', $number->id) }}"><i class="material-icons">delete_outline</i>Remove</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
